...
const ItemDetails = () => {
  ...
  const handleWhatsAppClick = () => {
    if (item) {
      const message = encodeURIComponent(`Olá! Tenho interesse no item: ${item.title}`);
          ...
          <div className={styles.info}>
            <div className={styles.header}>
              ...
              <div className={styles.priceBox}>
                ...
                <div className={styles.priceType}>{item.priceType}</div>
              </div>
            </div>
            ...
            {item.specifications && item.specifications.length > 0 && (
              <div className={styles.specifications}>
                <h2 className={styles.specificationsTitle}>Especificações Técnicas</h2>
            ...
            {item.minQuantity > 1 && (
              <div className={styles.minQuantityInfo}>
                ...
                <span>Quantidade mínima para locação: <strong>{item.minQuantity} unidades</strong></span>
              </div>
            )}
